...
set file=Open-Saber-Sound-Toolkit-r10
...
7z a -r -mx9 %file%.7z Mongo2*\*.*
7z a -r -mx9 %file%.7z Mongo1*\original_wav\*.*
7z a -r -mx9 %file%.7z Mongo2*\original_wav\*.*
7z a -r -mx9 %file%.7z Example*\*.*
...
7z a -r -mx9 %file%-SFX.exe Mongo2*\*.*
7z a -r -mx9 %file%-SFX.exe Mongo1*\original_wav\*.*
7z a -r -mx9 %file%-SFX.exe Mongo2*\original_wav\*.*
7z a -r -mx9 %file%-SFX.exe Example*\*.*
7z a -r -mx9 %file%-SFX.exe OpenCore_OEM\*.*
7z d -r -mx9 %file%-SFX.exe *.command
7z a -mx9 %file%-SFX.exe *.md
